...
class LMVC_Layout{
	...
	public function setLayout($module_name, $layout_dir=null, $layout_file=null){
		$this->_layouts[$module_name] = array('layout_dir'=> ((empty($layout_dir))? $this->getLayoutDir($module_name):$layout_dir) ,'layout_file'=>((empty($layout_file))?"Default.html":$layout_file));
	}
