...
abstract class LMVC_ActiveRecord {
	...
	private $applicationIgnoreFields = array('db', 'isEmpty', 'tableName', 'error_list', 'idField', 'ignoreFieldList', 'applicationIgnoreFields', 'dbIgnoreFields', 'tableInfo', 'dbEventListeners', 'updatedRows', 'deletedRows', '__currentAction', '_models' , 'parentModelHandles','transactionActivatedByCurrentClass');
	...
	{
		$appEvt = LMVC_AppEvent::getInstance();
